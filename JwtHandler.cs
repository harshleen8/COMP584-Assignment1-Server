...
namespace WebAPI
{
    public class JwtHandler
    {
        ...
        public JwtHandler(IConfiguration configuration, UserManager<HousingUser> userManager)
        {
            _configuration = configuration;
            _userManager = userManager;
        }

        public async Task<JwtSecurityToken> GetTokenAsync(HousingUser user) =>
            new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(HousingUser user)
        {
